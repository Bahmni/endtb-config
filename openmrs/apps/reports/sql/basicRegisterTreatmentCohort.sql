SELECT  ppa.value_reference AS `Registration Number`,
       ...
       TIMESTAMPDIFF(DAY,tStartDate.value_datetime, NOW())/30 AS `treatment duration`,
  ...
  regimen.`Amx-Clv`,
       ...
       DATE_FORMAT(end_of_treatment_obs.end_of_treatment_date, '%d/%b/%Y') AS `End of treatment`,
