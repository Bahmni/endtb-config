...
FROM
  (SELECT
     ...
     TRUNCATE(MAX(IF(tsd_cv.concept_full_name='TUBERCULOSIS DRUG TREATMENT START DATE',(TIMESTAMPDIFF(DAY,tsd.value_datetime, adm.obs_datetime) + 30.5)/30.5,NULL)),1)          AS 'Treatment Duration',
