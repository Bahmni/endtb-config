...
(4,'d_nextvis_base',@source_id,uuid(),now()),
(4,'d_nextvis_fup',@source_id,uuid(),now()),
(4,'d_nextvis_tx',@source_id,uuid(),now()),
...
(4,'d_sample_addl',@source_id,uuid(),now()),
(4,'d_sample_bio',@source_id,uuid(),now()),
(4,'d_sample_bk',@source_id,uuid(),now()),
(4,'d_sample_sero',@source_id,uuid(),now()),
...
(4,'hba1c_base',@source_id,uuid(),now()),
...
(4,'ht_base',@source_id,uuid(),now()),
(4,'ht_fup',@source_id,uuid(),now()),
...
(4,'id_pt_adm',@source_id,uuid(),now()),
(4,'id_pt_dis',@source_id,uuid(),now()),
(4,'id_pt_fup',@source_id,uuid(),now()),
...
(4,'pulse_base',@source_id,uuid(),now()),
(4,'pulse_fup',@source_id,uuid(),now()),
...
(4,'resp_base',@source_id,uuid(),now()),
(4,'resp_fup',@source_id,uuid(),now()),
...
(4,'va_l_base',@source_id,uuid(),now()),
(4,'va_l_fup',@source_id,uuid(),now()),
(4,'va_r_base',@source_id,uuid(),now()),
(4,'va_r_fup',@source_id,uuid(),now()),
(4,'vis_type',@source_id,uuid(),now()),
(4,'vl_test',@source_id,uuid(),now()),
(4,'wbc',@source_id,uuid(),now()),
(4,'wt_base',@source_id,uuid(),now()),
(4,'wt_fup',@source_id,uuid(),now()),
